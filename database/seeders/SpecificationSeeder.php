...
//        ];
        ...
        $data = [
            ['id' => 1, 'required' => false, 'title' => 'تعداد محور', 'type' => SpecificationTypeEnum::SELECT],
            ['id' => 2, 'required' => false, 'title' => 'تناژ', 'type' => SpecificationTypeEnum::INPUT_TEXT],
            ['id' => 3, 'required' => false, 'title' => 'سال تولید', 'type' => SpecificationTypeEnum::INPUT_TEXT],
            ['id' => 4, 'required' => false, 'title' => 'کارکرد', 'type' => SpecificationTypeEnum::INPUT_TEXT],
            ['id' => 5, 'required' => false, 'title' => 'گیربکس', 'type' => SpecificationTypeEnum::SELECT],
            ['id' => 6, 'required' => false, 'title' => 'نوع سوخت', 'type' => SpecificationTypeEnum::SELECT],
            ['id' => 7, 'required' => false, 'title' => 'تعداد جابه جایی سند', 'type' => SpecificationTypeEnum::INPUT_TEXT],
        ];
