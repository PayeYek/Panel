...
//        ];
        $data = [
            ...
            ['id' => 3, 'title' => 'سه محور', 'specification_id' => 1],
            ['id' => 4, 'title' => 'چهار محور', 'specification_id' => 1],
            ['id' => 5, 'title' => 'اتومات', 'specification_id' => 5],
            ['id' => 6, 'title' => 'دستی', 'specification_id' => 5],
            ['id' => 7, 'title' => 'نیمه اتومات', 'specification_id' => 5],
            ['id' => 8, 'title' => 'دیزل', 'specification_id' => 6],
            ['id' => 9, 'title' => 'بنزین', 'specification_id' => 6],
            ['id' => 10, 'title' => 'cng', 'specification_id' => 6],
            ['id' => 11, 'title' => 'برقی', 'specification_id' => 6],
        ];
