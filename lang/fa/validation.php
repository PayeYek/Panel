...
//    "required"         => "الزامی است",
    ...
    "required_if"          => "ورودی :attribute هنگامی که :other برابر با :value است، الزامی است.",
    ...
    */
    ...
    'custom'     => [
        'email' => [
            'valid_email_domain' => 'ایمیل وارد شده متعلق به دامنه‌ مجاز نیست.',
        ],
    ],
    ...
    */
    'attributes' => array(
        ...
        'chassis_condition'          => 'وضعیت شاسی ها',
        'body_condition'             => 'وضعیت بدنه',
        'third_party_insurance_date' => 'تاریخ انقضا بیمه نامه',
        ...
        'keyword'                    => 'کلمه کلیدی',
        'attributes'                 => 'ویژگی ها',
        'attributes.*.priority'      => 'اولویت',
        'product_id'                 => 'شناسه محصول',
        'state'                      => 'وضعیت',
        'note'                       => 'یادداشت',
        'purchased_product'          => 'محصول خریداری شده',
        'video'                      => 'ویدئو',
        'priority'                   => 'اولویت',
        'amount'                     => 'مبلغ',
        'file'                       => 'فایل',
