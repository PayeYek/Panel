...
@endpush
{{-- @dd($link) --}}
{{-- <x-splade-data default="{ showVideoModal: false }"> --}}
    <li class="">
        <div class="relative w-full pt-[66%] cursor-pointer {{ $radiusSize }} overflow-hidden drop-shadow-base" @click="data.showVideoModal = true; data.videoSrc='{!! $link !!}'; this.renderVideo">
