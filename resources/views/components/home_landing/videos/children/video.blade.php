...
@endpush
    <li class="">
        <div class="relative w-full pt-[66%] cursor-pointer {{ $radiusSize }} overflow-hidden drop-shadow-base videoThumbnails" @click="data.showVideoModal = true; data.videoSrc='{!! $link !!}'">
