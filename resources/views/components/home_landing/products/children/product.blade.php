...
@switch($type)
    @case(1)
        <div
            class="{{ $radiusSize }} {{ $borderStyle }} pt-2 px-8 w-full pb-5 items-center flex flex-col {{ $evenOdd == 'true' ? 'evenOdd_cards' : 'bg-white' }}">
            <div class="mb-2 h-36">
    ...
    @case(2)
        <div
            class="{{ $borderStyle }} {{ $radiusSize }} px-8 w-full pt-1 pb-8 items-center {{ $evenOdd == 'true' ? 'evenOdd_cards' : 'bg-white' }} flex flex-col">
    ...
    @case(4)
        <div
            class="{{ $borderStyle }} {{ $radiusSize }} pl-6 pr-8 w-full pt-5 pb-8 {{ $evenOdd == 'true' ? 'evenOdd_cards' : 'bg-white' }} flex flex-col">
    ...
    @case(5)
        <div
            class="{{ $borderStyle }} {{ $radiusSize }} px-6 gap-2 w-full pt-6 pb-10 {{ $evenOdd == 'true' ? 'evenOdd_cards' : 'bg-white' }} flex items-center">
