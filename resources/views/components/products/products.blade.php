...
<div class="grid grid-cols-1 gap-4 md:grid-cols-2 {{ $type === '1' ||  $type === '2' ? 'lg:grid-cols-5' : ($type === '3' ? 'lg:grid-cols-3' : ($type === '4' || $type === '5' ? 'lg:grid-cols-2' : ($type === '6' ? 'lg:grid-cols-2 md:gap-0' : 'lg:grid-cols-8'))) }}">
