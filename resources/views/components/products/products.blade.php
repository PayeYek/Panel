...
if($type === '1' || $type === '2'){
    ...
    $classType = 'md:grid-cols-1 rounded-xl overflow-hidden gap-0';
}elseif($type === '8'){
    $classType = 'md:grid-cols-1 rounded-xl overflow-hidden md:rounded-none md:overflow-auto gap-0 md:gap-4';
}elseif($type === '9'){
    $classType = 'lg:grid-cols-4 gap-4 lg:gap-0 lg:rounded-xl lg:overflow-hidden md:grid-cols-2';
}
@endphp
