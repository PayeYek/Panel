...
@switch($type)
    ...
    @case(7)
        <div
            ...
            <div class="h-32 mx-auto mb-3 md:h-40 md:mx-0 md:mb-0 md:w-40 md:flex-none">
                <img src="{{ $image }}" alt="mammut" class="object-contain h-full" />
            </div>
            <div class="mb-12 md:mb-0 md:flex-1">
                <h3 class="text-base font-bold text-gray-900 mb-7 dark:text-white md:line-clamp-1"> کامیون جفت محور 26 تن Shacmoto <span class="inline-block text-sm text-red-700 dark:text-red-600">&nbsp; X5000-D </span></h3>
