...
@switch($type)
    ...
    @case(5)
        <div
            ...
            <h3 class="pb-2 mb-5 border-b border-[#37474F]/40 text-lg font-bold text-gray-900 dark:text-white line-clamp-1">
                کامیون جک <span class="text-sm text-red-700 dark:text-red-600">&nbsp; X5000-D </span> <span
                    class="inline-block mr-2 text-lg sm:mr-4"> 8.5 تن </span></h3>
    ...
    @case(6)
        <div
            ...
            <h3
                class="pb-2 mb-5 border-b md:border-b-0 md:pb-0 border-[#37474F]/40 text-lg font-bold text-gray-900 dark:text-white line-clamp-1">
                کامیون جک <span class="text-sm text-red-700 dark:text-red-600">&nbsp; X5000-D </span> <span
                    class="inline-block mr-2 text-lg sm:mr-4"> 8.5 تن </span></h3>
            <div class="grid grid-cols-3 gap-4 mb-4">
                <div class="h-32">
