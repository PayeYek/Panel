            ...
            <section class="flex items-center justify-between h-full gap-5 default_container">
                <div class="flex items-center gap-2">
                    ...
                    <button @click.prevent="navigation.opened = !navigation.opened"
                        class="p-1 text-gray-600 rounded-lg cursor-pointer md:hidden hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 dark:text-gray-400">
                ...
                <x-layout.landing.navbar :land="$land" class-names="hidden md:flex" />
