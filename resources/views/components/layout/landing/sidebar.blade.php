...
<aside
    ...
    class="fixed top-0 ltr:left-0 rtl:right-0 z-[6] flex flex-col pb-5 px-4 w-64 h-screen pt-6 transition-transform -translate-x-full bg-white border-r border-gray-200 ltr:md:translate-x-0 rtl:md:translate-x-0 md:hidden"
>
    {{-- close menu --}}
    <button type="button" class="p-1 mb-2 mr-auto">
...
<div v-if="navigation.opened" @click.prevent="navigation.opened = !navigation.opened"
     class="bg-gray-900 bg-opacity-50 fixed inset-x-0 bottom-0 top-0 z-[5] md:hidden"></div>
