...
<aside
    ...
    class="fixed top-0 ltr:left-0 rtl:right-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 ltr:md:translate-x-0 rtl:md:translate-x-0 md:hidden dark:bg-gray-800 dark:border-gray-700"
>
    <div
