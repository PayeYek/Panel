...
<section class="lg:pt-24">
    ...
    <div class="flex_center flex-col gap-2 md:max-w-[524px] md:flex-row lg:gap-4">
        <x-pdp_landing.linkBtn text="دانلود کاتالوگ" class="{{ $radiusSize }} text-normal bg-white border border-normal hover:border-focus hover:text-focus focus:border-focus focus:text-focus focus:shadow-focus focus:shadow-shadowNormal" />
        <x-pdp_landing.linkBtn text="مشاوره و خرید" class="{{ $radiusSize }} text-white bg-normal hover:bg-focus focus:bg-focus focus:shadow-focus focus:shadow-shadowNormal" />
    </div>
</section>