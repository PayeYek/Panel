...
<section class="default_container">
    ...
    {{-- <div class="md:bg-white md:drop-shadow-base rounded-custom"> --}}
        <div class="md:w-[40rem] lg:w-[49rem] xl:w-[56rem] md:mx-auto md:pt-10 md:border md:border-[#E2E8F0] md:rounded-custom md:py-12 md:px-24 lg:px-36 xl:px-52">
            ...
            <x-splade-form :default="['product_id' => $product->id, 'land_id' => $land->id]"
                ...
                <section
                    class="rounded-custom md:rounded-none pt-6 pb-8 md:py-0 flex flex-col items-center">
                    <div
