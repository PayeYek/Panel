        ...
        <div class="md:w-[492px] md:mx-auto md:pt-10 bg-white">
            ...
            <x-splade-form
                ...
                <section class="drop-shadow-base md:drop-shadow-none bg-white {{ $radiusSize }} md:rounded-none md:bg-transparent pt-6 pb-8 md:pb-11 flex flex-col items-center">
                    ...
                    <button type="submit" class="{{ $radiusSize }} flex_center w-64 h-11 text-white bg-normal hover:bg-focus focus:bg-focus focus:shadow-focus focus:shadow-shadowNormal"> ارسال </button>
                </section>
            </x-splade-form>
        </div>
    </div>
