            ...
            <div id="indicators-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative overflow-hidden rounded-lg aspect-square md:aspect-video ">
                    ...
                    <div class=" duration-700 ease-in-out" data-carousel-item="active">
                        <img src="https://postimage01.divarcdn.com/static/photo/afra/post/v9ef_bRHlO1kD-WC08FS3Q/f5a96689-1d90-4668-8f61-f9ce389a2f89.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    </div>
                </div>
                <!-- Slider indicators -->
