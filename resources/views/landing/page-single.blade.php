<x-layout.landing.land :land="$land">
    ...
    <section class="flex items-center justify-between gap-3 px-5 mb-16 lg:justify-start">
        ...
        <div class="flex items-center gap-5 p-4 overflow-auto text-base font-bold text-red-700">
            <a href="#" class="w-[140px] h-8 flex_center rounded drop-shadow-[0_2px_8px_rgba(185,28,28,0.3)] bg-white flex-none"> کشنده </a>
            <a href="#" class="w-[140px] h-8 flex_center rounded drop-shadow-[0_2px_8px_rgba(185,28,28,0.3)] bg-white flex-none"> کامیون </a>
            <a href="#" class="w-[140px] h-8 flex_center rounded drop-shadow-[0_2px_8px_rgba(185,28,28,0.3)] bg-white flex-none"> کامییونت </a>
            <a href="#" class="w-[140px] h-8 flex_center rounded drop-shadow-[0_2px_8px_rgba(185,28,28,0.3)] bg-white flex-none"> ون </a>
        </div>
    </section>
    ...
    <section class="px-5 mb-16 xl:px-0">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-5">
            <div class="drop-shadow-[0_2px_10px_rgba(0,0,0,0.15)] rounded px-10 lg:px-5 xl:px-10 pb-5 items-center pt-3 bg-white flex flex-col">
                ...
                <a href="#" class="w-full mt-4 text-lg font-bold text-red-700 border border-red-700 rounded h-11 flex_center"> مشخصات </a>
                <a href="#" class="w-full mt-4 text-lg font-bold text-red-700 border border-red-700 rounded h-11 flex_center"> مشخصات </a>
                <a href="#" class="w-full mt-4 text-lg font-bold text-red-700 border border-red-700 rounded h-11 flex_center"> مشخصات </a>
            </div>
            <div class="drop-shadow-[0_2px_10px_rgba(0,0,0,0.15)] rounded px-10 lg:px-5 xl:px-10 pb-5 items-center pt-3 bg-white flex flex-col">
    ...
    <section class="px-5 mb-32 xl:px-0">
        ...
        <div class="flex items-center justify-between mb-16 lg:px-4">
            ...
            <a href="#" class="flex items-center gap-2 text-xs font-normal text-red-700">
                ...
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8.88759 15.8327L3.33203 9.99935M3.33203 9.99935L8.88759 4.16602M3.33203 9.99935L16.6654 9.99935" stroke="#B91C1C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </a>
        </div>
        ...
        <ul class="list-none">
            <li class="flex flex-col md:flex-row rounded-xl bg-white drop-shadow-[0_4px_20px_rgba(0,0,0,0.15)]">
                {{-- image --}}
                <div class="h-48 overflow-hidden md:flex-none md:w-[22rem] md:h-56 md:rounded-tl-none md:rounded-br-xl rounded-t-xl">
                    <img src="{{ asset('assets/images/test/jac.jpg') }}" alt="jax" class="object-cover w-full h-full" />
                </div>
                {{-- docs --}}
                <div class="p-4">
                    <h3 class="mb-4 text-lg font-bold text-gray-900"> عنوان اطلاعیه </h3>
                    <p class="text-base line-clamp-6 md:line-clamp-3 leading-7 lg:leading-8 mb-2 font-normal text-[#818284]">
                        شرکت آرین دیزل که نماینده انحصاری شرکت خودروسازی جک موتورز در ایران است مسئولیت تولید و مونتاژ محصولات شرکت خودروسازی را بر عهده دارد و با بهره مندی از مهندسان با تجربه نسبت به محصولاتی مرغوب، قابل اطمینان اقدام نموده است و با توجه به اینکه محصولات خود را با مرغوب‌ترین قطعات تولید می‌کند توانسته به جایگاه ویژه ای در صنعت خودروسازی ایران دست پیدا کند.کامیونت جک ۸.۵ تن یکی از محصولاتی است که توسط این شرکت در ایران تولید می‌شود و با توجه به عملکرد خوبی که دارد قابلیت رقابت با خودروهای اروپایی را دارد و این امر آرین دیزل را در زمره ی بهترین شرکت‌های خودروسازی قرار داده است.
                    </p>
                    <a href="#" class="mr-auto text-sm font-bold text-white bg-red-700 rounded flex_center h-9 w-28"> بیشتر </a>
                </div>
            </li>
        </ul>
    </section>
        ...
        <ul class="grid grid-cols-1 gap-4 list-none lg:grid-cols-4">
            <li class="flex flex-col border-2 rounded border-gray-900/50">
                ...
                <div class="px-5 pt-3 pb-5">
                    <h3 class="mb-2 text-lg font-bold text-gray-900 line-clamp-1"> معرفی شرکت تولید کننده جک ۸.۵ تن </h3>
