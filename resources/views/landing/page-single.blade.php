<x-layout.default.main :land="$land">
    <main class="">
        ...
        <section class="default_container">
            <section
                class="grid grid-cols-1 sm:grid-cols-2 mb-12 gap-4 *:rounded-custom sm:*:rounded-none sm:rounded-custom sm:overflow-hidden sm:gap-0 *:bg-[#f5f5f5] *:flex_center *:flex-col *:text-stone-700 *:aspect-video">
                {{-- branches --}}
                <Link href="#">
        ...
        {{-- favorites --}}
        <x-home_landing.products :landSlug="$land->slug" :data="$land->products" :type="$land->styles->product_card_type" :borderType="$land->styles->border_type"
