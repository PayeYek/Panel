    ...
    <main class="pt-4 relative default_container hidden">
        ...
        <section class="flex flex-col bg-white drop-shadow-base {{ $radiusSize }} overflow-hidden mb-8 sm:mx-6 md:mx-10 lg:mb-12">
            ...
            <form action="#" method="#" class="pb-10 pt-6 px-5 flex flex-col items-center">
                ...
                <button type="submit" class="{{ $radiusSize }} flex_center w-full max-w-72 h-11 text-base font-bold bg-violet-600 text-white"> ثبت درخواست </button>
            </form>
        </section>
            ...
            <section class="flex flex-col gap-6 lg:w-72 lg:flex-none order-2 lg:order-1">
                ...
                <section class="relative pb-10 sm:pb-0 lg:pb-10">
                    ...
                    <div class="flex items-center mb-4 sm:justify-between lg:px-4">
                        ...
                        <a href="#" class="items-center absolute bottom-0 sm:static lg:absolute right-4 lg:right-auto lg:left-2 gap-2 text-base font-normal flex text-violet-600">
                            <span> مشاهده همه </span>
                            <svg class="stroke-current" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15 17L10 12L15 7" stroke="current" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-white drop-shadow-base {{ $radiusSize }} overflow-hidden sm:mx-6 md:mx-10 lg:mx-0">
                    {{-- title --}}
                    <div class="h-20 w-full bg-violet-600 text-white text-xl font-black flex_center">
                        <p> ارتباط با کارشناسان فروش </p>
                    </div>
    ...
    <main class="pt-4 relative default_container hidden">
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="w-full lg:flex-1">
                ...
                {{-- details --}}
                <section class="mb-8 lg:mb-0 custom_table_striped_container">
                    {!! $article->body !!}
                </section>
            </section>
            ...
            <section class="flex flex-col gap-6 lg:w-72 lg:flex-none">
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-violet-600 drop-shadow-base {{ $radiusSize }} overflow-hidden sm:mx-6 md:mx-10 lg:mx-0">
                    {{-- title --}}
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="flex flex-col gap-6 lg:gap-8 lg:w-72 lg:flex-none order-2 lg:order-1">
                ...
                <section class="relative">
                    {{-- header --}}
                    <div class="flex_center mb-4 lg:mb-3 h-20 w-full {{ $bgStyle }} {{ $radiusSize }}">
                        <h3 class="text-xl font-black text-white"> فهرست آخرین اخبار و اطلاعیه ها </h3>
                    </div>
                    {{-- next & prev news btn --}}
                    <div class="w-full text-sm font-normal text-gray-900 h-12 lg:h-8 mb-4 lg:mb-3 {{ $radiusSize }} bg-white drop-shadow-base px-4 flex items-center justify-between">
                        {{-- prev --}}
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-white drop-shadow-base {{ $radiusSize }} overflow-hidden mb-8 sm:mx-6 md:mx-10 lg:mx-0 lg:mb-0">
                    {{-- title --}}
                    <div class="h-20 w-full bg-violet-600 text-white text-xl font-black flex_center">
                        <p> ارتباط با کارشناسان فروش </p>
                    </div>
    ...
    <main class="pt-4 relative default_container">
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="w-full lg:flex-1 order-1 lg:order-2">
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col {{ $bgStyle }} pb-12 pt-8 drop-shadow-base {{ $radiusSize }} mb-8 sm:mx-6 md:mx-10 lg:mx-12 lg:mb-0">
                    {{-- title --}}
            ...
            <section class="flex flex-col lg:w-72 lg:flex-none order-2 lg:order-1 lg:pt-12">
                ...
                <form action="#" class="h-10 relative mb-3.5 max-w-96 w-full mr-auto lg:mr-0 lg:max-w-full">
                    <input type="text" class="w-full h-full {{ $radiusSize }} border border-gray-900 focus:ring-0 outline-none pl-10 pr-2 placeholder:text-[#888b93] text-sm font-normal focus:border-gray-900" placeholder="جستجوی عنوان" />
