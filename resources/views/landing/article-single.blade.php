        ...
        <main class="relative pt-4">
            ...
            <div class="default_container mb-2 md:mb-4 lg:mb-8">
                <div class="w-full relative pt-[56%] rounded-custom overflow-hidden">
                    <img src="{{ $article->image }}" alt="{{ $article->title }}" class="absolute top-0 left-0 w-full h-full" />
                    <div class="absolute z-[1] bottom-0 sm:bottom-6 text-base sm:text-xl lg:text-2xl left-0 w-full px-4 lg:px-6 bg-gradient-to-r from-[rgba(46,48,146,0.5)] to-[rgba(46,48,146,1)] h-12 sm:h-16 lg:h-24 flex items-center line-clamp-1 text-white">
                        {{ $article->title }}
                    </div>
                </div>
            </div>
