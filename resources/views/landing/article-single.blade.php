...
<x-layout.default.main :land="$land">
    ...
    <main class="pt-20 sm:pt-24 relative default_container">
        ...
        {{-- contact to expert --}}
        <section class="flex flex-col bg-white {{ $borderType }} rounded-custom overflow-hidden mb-8 sm:mx-6 md:mx-10 lg:mb-12">
            {{-- title --}}
            ...
            <form action="#" method="#" class="pb-10 pt-6 px-5 flex flex-col items-center">
                ...
                <input name="phone" type="tel" class="bg-dark-50 mb-12 max-w-72 h-10 border-0 focus:ring-0 rounded-custom outline-none w-full placeholder:text-[#888b93] text-sm font-normal px-3 text-gray-900" placeholder="09" />
                <button type="submit" class="rounded-custom flex_center w-full max-w-72 h-11 text-base font-bold bg-normal hover:bg-focus focus:bg-focus focus:shadow-focus focus:shadow-shadowNormal text-white"> ثبت درخواست </button>
            </form>
        </section>
        ...
        <section class="relative pb-10 sm:pb-0">
            ...
            <ul class="grid grid-cols-1 md:grid-cols-3 gap-4 list-none">
                @foreach ($land->articles->take(3) as $article)
                    <li class="flex flex-col bg-white w-full rounded-custom overflow-hidden {{ $borderType }}">
                        ...
                        <div class="px-5 pt-2 pb-4 flex flex-col">
                            <p class="text-lg font-bold text-gray-900 mb-2 text-justify md:line-clamp-1"> {{ $article->title }} </p>
                            <p class="text-sm font-normal text-gray-900 line-clamp-3 leading-7 text-justify mb-3 md:h-20">
                                {{ $article->description }}
                            </p>
                            <a href="{{ route('landing.article.show',['page'=> $land->slug, 'article'=> $article->slug]) }}" class="items-center gap-3 text-sm font-bold flex text-normal mr-auto pb-2 pt-1">
                                <span> ادامه </span>
    ...
    <main class="pt-20 sm:pt-24 relative default_container">
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="w-full lg:flex-1 order-1 lg:order-2">
                ...
                <div class="w-full relative pt-[56%] mb-2 md:mb-4 lg:mb-8 rounded-custom overflow-hidden">
                    <img src="https://paye1.com/storage/media/land/files/d2x7MNw4kS6JWjSomLV9hL2aN9sWkjbm7xgGAxqZ.jpg" alt="{{$article->title}}" class="absolute top-0 left-0 w-full h-full" />
                    <div class="absolute z-[1] bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-black to-transparent"></div>
                </div>
            ...
            <section class="flex flex-col gap-6 lg:w-72 lg:flex-none order-2 lg:order-1">
                ...
                <section class="relative pb-10 sm:pb-0 lg:pb-10">
                    ...
                    <ul class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-1 gap-4 list-none">
                        @foreach ($land->articles->take(3) as $article)
                            <li class="flex flex-col bg-white w-full rounded-custom overflow-hidden {{ $borderType }}">
                                <div class="relative w-full pt-[62%] mb-2">
                                    <img src="{{ $article->image }}" alt="{{ $article->title }}" class="absolute top-0 left-0 w-full h-full" />
                                ...
                                {{-- info --}}
                                <div class="px-5 pt-2 pb-4 flex flex-col">
                                    <p class="text-lg font-bold text-gray-900 mb-2 text-justify md:line-clamp-1 lg:line-clamp-none"> {{ $article->title }} </p>
                                    <p class="text-sm font-normal text-gray-900 line-clamp-3 leading-7 md:h-20 lg:h-auto text-justify mb-3">
                                        {{ $article->description }}
                                    </p>
                                    <a href="{{ route('landing.article.show',['page'=> $land->slug, 'article'=> $article->slug]) }}" class="items-center gap-3 text-sm font-bold flex text-normal mr-auto pb-2 pt-1">
                                        <span> ادامه </span>
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-white {{ $borderType }} rounded-custom overflow-hidden sm:mx-6 md:mx-10 lg:mx-0">
                    {{-- title --}}
                    <div class="h-20 w-full bg-normal text-white text-xl font-black flex_center">
                        <p> ارتباط با کارشناسان فروش </p>
                    </div>
                    <form action="#" method="#" class="pb-10 pt-6 px-5 flex flex-col items-center">
                        <p class="text-base font-normal leading-7 text-normal mb-6"> جهت ارتباط و اطلاع از شرایط فروش شماره خود را وارد کنید. </p>
                        <input name="phone" type="tel" class="bg-dark-50 mb-12 h-10 w-full max-w-72 border-0 focus:ring-0 rounded-custom outline-none w-full placeholder:text-[#888b93] text-sm font-normal px-3 text-gray-900" placeholder="09" />
                        <button type="submit" class="rounded-custom flex_center w-full max-w-72 h-11 text-base font-bold bg-normal hover:bg-focus focus:bg-focus focus:shadow-focus focus:shadow-shadowNormal text-white"> ثبت درخواست </button>
                    </form>
                </section>
            </section>
    ...
    <main class="pt-20 sm:pt-24 relative default_container">
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="flex flex-col gap-6 lg:w-72 lg:flex-none">
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-normal {{ $borderType }} rounded-custom overflow-hidden sm:mx-6 md:mx-10 lg:mx-0">
                    {{-- title --}}
                    ...
                    <form action="#" method="#" class="pb-10 pt-6 px-5 flex flex-col items-center">
                        ...
                        <input name="phone" type="tel" class="bg-white mb-12 h-10 w-full max-w-72 border-0 focus:ring-0 rounded-custom outline-none w-full placeholder:text-[#888b93] text-sm font-normal px-3 text-gray-900" placeholder="09" />
                        <button type="submit" class="rounded-custom flex_center w-full max-w-72 h-11 text-base font-bold border border-white text-white"> ثبت درخواست </button>
                    </form>
                </section>
            </section>
        </section>
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="flex flex-col gap-6 lg:gap-8 lg:w-72 lg:flex-none order-2 lg:order-1">
                ...
                <section class="relative">
                    {{-- header --}}
                    <div class="flex_center mb-4 lg:mb-3 h-20 w-full bg-normal rounded-custom">
                    ...
                    <ul class="flex flex-col gap-4 list-none">
                        @foreach ($land->articles->take(3) as $article)
                            <li class="grid grid-cols-10 bg-white w-full rounded-custom overflow-hidden {{ $borderType }}">
                                ...
                                {{-- info --}}
                                <div class="px-5 pt-2 pb-4 flex flex-col col-span-6 bg-dark-50 p-2 sm:pr-4 sm:py-4 sm:pl-6 lg:py-2 lg:pr-3 lg:pl-2 sm:gap-4 lg:gap-2 sm:justify-center">
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-white {{ $borderType }} rounded-custom overflow-hidden mb-8 sm:mx-6 md:mx-10 lg:mx-0 lg:mb-0">
                    {{-- title --}}
                    <div class="h-20 w-full bg-normal text-white text-xl lg:text-lg font-black flex_center">
                        <p> ارتباط با کارشناسان فروش </p>
                    </div>
                    <form action="#" method="#" class="pb-10 pt-6 px-5 flex flex-col items-center">
                        <p class="text-base font-normal leading-7 text-normal mb-6"> جهت ارتباط و اطلاع از شرایط فروش شماره خود را وارد کنید. </p>
                        <input name="phone" type="tel" class="bg-dark-50 mb-12 max-w-72 h-10 border-0 focus:ring-0 rounded-custom outline-none w-full placeholder:text-[#888b93] text-sm font-normal px-3 text-gray-900" placeholder="09" />
                        <button type="submit" class="rounded-custom flex_center w-full max-w-72 h-11 text-base font-bold bg-normal text-white"> ثبت درخواست </button>
                    </form>
                </section>
            </section>
        </section>
    ...
    <main class="pt-20 sm:pt-24 relative default_container">
        ...
        <section class="flex flex-col lg:flex-row lg:items-start gap-8">
            ...
            <section class="w-full lg:flex-1 order-1 lg:order-2">
                ...
                {{-- contact to expert --}}
                <section class="flex flex-col bg-normal pb-12 pt-8 {{ $borderType }} rounded-custom mb-8 sm:mx-6 md:mx-10 lg:mx-12 lg:mb-0">
                    {{-- title --}}
                    ...
                    <form action="#" method="#" class="px-5 flex flex-col items-center">
                        <p class="text-base font-normal leading-7 text-white mb-6"> جهت ارتباط و اطلاع از شرایط فروش شماره خود را وارد کنید. </p>
                        <input name="phone" type="tel" class="bg-dark-50 mb-6 max-w-72 h-10 border-0 focus:ring-0 rounded-custom outline-none w-full placeholder:text-[#888b93] text-sm font-normal px-3 text-gray-900" placeholder="09" />
                        <button type="submit" class="rounded-custom flex_center w-full max-w-72 h-11 text-base font-bold border border-white text-white"> ثبت درخواست </button>
                    </form>
                </section>
            </section>
            ...
            <section class="flex flex-col lg:w-72 lg:flex-none order-2 lg:order-1 lg:pt-12">
                ...
                <form action="#" class="h-10 relative mb-3.5 max-w-96 w-full mr-auto lg:mr-0 lg:max-w-full">
                    <input type="text" class="w-full h-full rounded-custom border border-gray-900 text-gray-900 focus:ring-0 outline-none pl-10 pr-2 placeholder:text-[#888b93] text-sm font-normal focus:border-gray-900" placeholder="جستجوی عنوان" />
                ...
                <ul class="flex flex-col gap-4 list-none">
                    @foreach ($land->articles->take(3) as $article)
                        <li class="grid grid-cols-10 bg-white w-full rounded-custom overflow-hidden {{ $borderType }}">
                            ...
                            {{-- info --}}
                            <div class="px-5 pt-2 pb-4 flex flex-col col-span-6 p-2 sm:pr-4 sm:py-4 sm:pl-6 lg:py-2 lg:pr-3 lg:pl-2 sm:gap-4 lg:gap-2 sm:justify-center">
