...
<x-layout.default.main :land="$land">
    <main class="pt-4 relative">
        ...
        <section class="default_container">
            ...
            <p class="text-justify text-sm font-normal leading-6 mb-5">
            ...
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div class="drop-shadow-base flex flex-col px-16 md:px-12 pt-4 pb-12 bg-white">
                    <p class="text-center text-red-700 text-base font-bold mb-12"> شعبه مرکزی </p>
                    {{-- address --}}
                    <div class="flex items-start gap-3.5 mb-4">
                        {{-- icon --}}
                        <svg class="stroke-red-700" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="drop-shadow-base flex flex-col px-16 md:px-12 pt-4 pb-12 bg-white">
                    <p class="text-center text-red-700 text-base font-bold mb-12"> شعبه اسلامشهر </p>
                    {{-- address --}}
                    <div class="flex items-start gap-3.5 mb-4">
                        {{-- icon --}}
                        <svg class="stroke-red-700" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {{-- send message --}}
            <section class="bg-white drop-shadow-base px-4 pb-8 pt-2 sm:pt-4 md:pt-8 sm:pb-10 md:pb-12">
                <div class="md:w-[492px] md:mx-auto">
                    <p class="text-base font-bold mb-4 text-red-700 text-center md:text-right md:mb-6"> ارسال پیام </p>
                    ...
                    <section class="flex flex-col items-center">
                        <form action="#" id="addComment" class="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 md:gap-y-4 gap-2 w-56 mb-6 md:mb-20 md:w-full">
                            <input name="fullName" type="text" class="shadow-glass shadow-black/30 h-12 border-0 focus:ring-0 outline-none w-full placeholder:text-[#888b93] text-sm font-normal pr-3 pl-6 text-gray-900" placeholder="نام" />
                            <select name="subject" class="shadow-glass shadow-black/30 h-12 border-0 focus:ring-0 outline-none w-full text-sm font-normal text-gray-900">
                                <option value="0" disabled selected> موضوع پیام </option>
                                <option value="1"> موضوع 1 </option>
                                <option value="2"> موضوع 2 </option>
                            </select>
                            <input name="phone" type="tel" class="shadow-glass shadow-black/30 h-12 border-0 focus:ring-0 outline-none w-full placeholder:text-[#888b93] text-sm font-normal pr-3 pl-6 text-gray-900 dir-rtl" placeholder="شماره همراه (اختیاری)" />
                            <label for="email" class="h-12 w-full relative">
                                <input id="email" required name="email" type="text" class="peer h-full shadow-glass shadow-black/30 border-0 focus:ring-0 outline-none w-full placeholder:text-[#888b93] text-sm font-normal pr-3 pl-6 text-gray-900" placeholder="ایمیل" />
                                <i class="absolute top-2 right-16 text-red-700 peer-valid:hidden">*</i>
                            </label>
                            <label for="comment" class="w-full relative h-40 md:h-32 md:col-span-2">
                                <textarea required name="comment" class="shadow-glass shadow-black/30 h-full resize-none peer border-0 focus:ring-0 outline-none w-full placeholder:text-[#888b93] text-sm font-normal pr-3 pl-6 text-gray-900" placeholder="دیدگاه"></textarea>
                                <i class="absolute top-1 right-[52px] text-red-700 peer-valid:hidden">*</i>
                            </label>
                        </form>
                        <button type="submit" form="addComment" class="flex_center w-64 h-11"> ارسال </button>
                    </section>
                </div>
            </section>
        </section>
