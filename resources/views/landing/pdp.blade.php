...
<x-layout.default.main :land="$land">
    <main class="pt-4 relative">
        ...
        <x-home_landing.videos colorPalette="{{ $land->styles->color }}" radius="{{ $land->styles->radius }}"
                               :data="$land->videos"/>

        {{-- add viewpoint --}}
        <x-pdp_landing.addViewpoint radius="{{ $land->styles->radius }}" colorPalette="{{ $land->styles->color }}"
