<x-layout.admin>
    <x-splade-modal>
        <x-splade-form :action="route('panel.marketing.card.store')"
                       :default="['status' => 1,'type' => 0, 'address'=>'', 'link'=>'https://niyaze.com/product']"
        >

            <x-layout.panel.form.card title="New Card">
                ...
                <x-layout.panel.form.division col="1">
                    ...
                    <x-splade-group name="type" label="Type" inline required>
                        <x-splade-radio name="type" value="0" label="Rectangle"/>
                        <x-splade-radio name="type" value="1" label="Circle"/>
                    </x-splade-group>
