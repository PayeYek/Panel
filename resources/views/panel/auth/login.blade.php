                    ...
                    <x-splade-form :action="route('auth.enter')" :default="['remember' => false]">
                        ...
                        <x-layout.panel.form.card title="Login" class="mt-5">
                            ...
                            <x-layout.panel.form.division>
                                ...
                                <x-splade-input name="username" label="Username" required ltr
                                                placeholder="Username | Mobile | eMail"/>

                                <x-splade-input name="password" label="Password" type="password" placeholder="x x x x x"
                                                required ltr/>

                                <div class="flex items-center justify-between">
                                    <x-splade-checkbox class="text-sm" name="remember" label="Remember me"/>
                                    <x-splade-link :href="route('auth.forget')"
                                        class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 underline-offset-8 decoration-2">{{ __('Forgot Password?') }}</x-splade-link>
                                </div>
                                ...
                                <span class="text-sm text-gray-500 dark:text-gray-400">
                                    ...
                                    <x-splade-link
                                        ...
                                        class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500 underline-offset-8 decoration-2">{{ __('Sign up here.') }}</x-splade-link>
                                </span>
                            </x-layout.panel.form.division>
