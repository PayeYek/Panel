...
<x-layout.admin>
    ...
    <x-splade-modal>
        <x-splade-form :default="$color" method="put" :action="route('panel.ad.color.update', $color)">
            ...
            <x-layout.panel.form.card title="Edit Color">
                ...
                <div class="flex gap-4">
                    <x-splade-select label="Color selection" name="name" :options="Help::colors()" required
