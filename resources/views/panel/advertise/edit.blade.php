...
<x-layout.admin>
    <x-splade-modal>
        <x-splade-form :default="$advertise" method="put" :action="route('panel.ad.advertise.update', $advertise)">

            <x-layout.panel.form.card title="Update Advertise">
                ...
                <x-splade-input help="وضعیت موتور خودرو را شرح دهید" label="Engine Condition" name="engine_condition"
                                class="col-span-full"/>
                <x-splade-input help="وضعیت شاسی های خودرو را شرح دهید" label="Chassis Condition"
                                name="chassis_condition" class="col-span-full"/>
                <x-splade-input help="وضعیت بدنه خودرو را شرح دهید" label="Body Condition" name="body_condition"
                                class="col-span-full"/>
