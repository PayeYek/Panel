<x-layout.admin>
    <x-splade-modal>
        <x-splade-form :default="$slider" method="put" :action="route('panel.marketing.slider.update', $slider)">
...
{{--                                   :min-resolution="1536 * 720"--}}
                    ...
                    <x-splade-group name="status" label="Status" inline required>
                        <x-splade-radio name="status" value="0" label="Invisible" :checked="$slider->status == 0"/>
                        <x-splade-radio name="status" value="1" label="Visible"   :checked="$slider->status == 1"/>
                    </x-splade-group>
