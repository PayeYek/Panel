<x-layout.admin>
    ...
    <x-splade-modal>
        <x-splade-form :action="route('panel.application.commodity.store')" default="{ day: 0 }">

            <x-layout.panel.form.card title="New Commodity">
...
{{--                    <input name="day" type="hidden" v-bind:value="form.type!=2 ? 0 : form.period"/>--}}
