    ...
    <x-splade-modal>
        <x-splade-form :default="[
            ...
            <x-layout.panel.form.card title="New Notice">
                ...
                <x-layout.panel.form.division :col="4">
                    <x-splade-select name="company_id" label="Company" :options="$companies" placeholder="Select an item"/>
                    <x-splade-input name="expired_at" label="Expire date" date time ltr required/>
                    <x-splade-input name="published_at" label="Publish date" date time ltr/>
                    <x-splade-input name="circularNo" label="Circular No"/>
