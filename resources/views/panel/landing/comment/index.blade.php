        ...
        <div class="flex gap-2">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex gap-1 items-center mt-2 opacity-75 dark:opacity-50">
                    <svg class="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    ...
                    <div class="inline-flex items-center shrink-0">
                        @for($i = 1 ; $i <= 5 ; $i++)
                            <svg class="h-4 w-4 {{$i <= $item->star ? 'fill-amber-500' : 'fill-gray-500 opacity-50'  }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon">
