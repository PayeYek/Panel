<x-layout.admin>
    <x-splade-modal>
        <x-splade-form :default="$announcement" method="put"
                       :action="route('panel.landing.announcement.update', $announcement)">
            <x-layout.panel.form.card title="Edit Announcement">
