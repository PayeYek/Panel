<x-layout.admin>
    ...
    <x-splade-table :for="$items"
                    :primaryLink="route('panel.landing.article.create')"
    ...
    >
        ...
        <x-layout.panel.more-buttons>
            <div class="py-2 first:pt-0 last:pb-0">
                <x-layout.panel.list.edit table="landing.article" :item="$item"/>
            </div>
            <div class="py-2 first:pt-0 last:pb-0">
                <x-layout.panel.list.destroy table="landing.article" :item="$item"/>
            </div>
        </x-layout.panel.more-buttons>
        @endcell
