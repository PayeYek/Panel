<x-layout.admin>
    ...
    <x-splade-table :for="$items"
                    :primaryLink="route('panel.blog.file.create')"
                    :title="__('File list')"
    ...
    >
        ...
        <Link
            slideover
            href="{{ route('panel.blog.file.edit', $item) }}"
        ...
        <x-layout.panel.more-buttons>
            <div class="py-2 first:pt-0 last:pb-0">
                <x-layout.panel.list.edit table="blog.file" :item="$item" slideover/>
            </div>
            <div class="py-2 first:pt-0 last:pb-0">
                <x-layout.panel.list.destroy table="blog.file" :item="$item"/>
            </div>
        </x-layout.panel.more-buttons>
        @endcell
