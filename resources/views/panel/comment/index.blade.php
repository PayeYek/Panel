<x-layout.admin>
    ...
    <x-splade-table :for="$items" search-debounce="1000" striped
                    :primaryLink="route('panel.interaction.comment.create')"
    ...
    >
        ...
        <Link
            ...
            cancel-button="{{__('No')}}"
            method="POST"
            href="{{ $item->approved == 0 ? route('panel.interaction.comment.publish', $item->id) : route('panel.interaction.comment.hidden', $item->id)}}"
        ...
        <x-layout.panel.more-buttons>
            <div class="py-2 first:pt-0 last:pb-0">
                ...
                <Link slideover
                      href="{{ route('panel.interaction.comment.edit', $item) }}"
            ...
            <div class="py-2 first:pt-0 last:pb-0">
                <Link method="delete" confirm
                      href="{{ route('panel.interaction.comment.destroy', $item) }}"
