...
export default {
    ...
    setup() {
        ...
        const loanOrder = (payload) => {
            console.log(typeof loanInitialValue.value, typeof loanMax.value, typeof payload, typeof loanSteps.value);
            ...
            console.log(numberWithCommas(loanInitialValue.value));
        }
