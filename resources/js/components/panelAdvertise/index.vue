<template>
    <section
        ...
        <!-- submit-->
        <SubmitForm :classNames="usageFilled == null ? 'pointer-events-none opacity-40 cursor-default' : 'mb-10'" />
    </section>
</template>
...
export default {
    ...
    components: {Category, Usage, Specifications, Introduction, SubmitForm},
    setup(){
