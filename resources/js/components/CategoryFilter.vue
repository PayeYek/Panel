        ...
        <div :class="'grid grid-cols-1 ' + classType">
            <template v-for="(product, index) in filteredList">
                ...
                <div v-if="productType == 1" :key="index"
                    :class="'pt-2 px-8 w-full pb-5 items-center flex flex-col rounded-custom ' + borderStyle + ' ' + (evenOdd ? 'evenOdd_cards ' : 'bg-white ')">
                    <div class="mb-2 h-36">
                        <img :src="product.image" :alt="product.name" class="object-contain h-full" />
                    </div>
                    <h3 class="mb-5 font-bold lg:mb-4 text-lg sm:line-clamp-1 text-stone-700"> {{ product.name }} </h3>
                ...
                <div v-if="productType == 2" :key="index"
                    ...
                    <h3 class="mb-0.5 font-bold lg:mb-1 text-lg sm:line-clamp-1 text-stone-700"> {{ product.name }} </h3>
                ...
                <div v-if="productType == 4" :key="index"
                    ...
                    <h3 class="mb-1.5 font-bold lg:mb-1 text-lg sm:line-clamp-1 text-stone-700"> {{ product.name }} </h3>
            ...
            <template v-if="productType == 12">
                <section class="flex flex-col" v-for="(product, index) in filteredList" :key="index">
                    ...
                    <ul class="flex flex-col lg:flex-row lg:items-start lg:justify-center gap-0">
                        <li  v-for="(item, index) in product" :class="'pt-2 px-8 w-72 pb-5 items-center flex flex-col rounded-custom ' + (evenOdd ? 'evenOdd_cards' : 'bg-white')">
                            <div class="mb-2 h-52">
